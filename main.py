...
def onmessage(update,bot:ObigramClient):
    try:
        ...
        message = bot.sendMessage(update.message.chat.id,'🤖Iniciando Sesion💻...')

        thread.store('msg',message)

        if '/start' in msgText:
            start_msg = '👾ʙᴏᴛ ᴘᴇʀsᴏɴᴀʟ👾\n'
            start_msg+= '࿇ ══━━━━✥◈✥━━━━══ ࿇\n'
            start_msg+= '🤖Hola @' + str(username)+'\n'
            start_msg+= '✅Bot privado para subir y descargar de la nube sin consumo de MB.\n'
